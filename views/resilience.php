<div class="section-page page-resilience">
	...
	<div class="page-row slide-row">
		<div class="vid-box">
				<img class="size-slide-img" src="img/resilience/slide-01.jpg"/>
		...
		<div class="headquote">
			<img src="img/resilience/resilience-headquote.png"/>
		</div>
	</div>
	<div class="page-row">
		<div class="upperbg">
	...
	<div class="page-row">
		<div class="thumb-duo">
			<div class="thumb">
				<a class="uncover" href="img/resilience/resilience-lg7.jpg" data-lightbox="resilience-set" data-title=""></a>			
				<div class="hover-fx"><div class="expand-cta">EXPAND</div></div>
				<img src="img/resilience/resilience-tn4.png" alt=""/>
			</div>
			<div class="thumb thumb-end">
				<a class="uncover" href="img/resilience/resilience-lg8.jpg" data-lightbox="resilience-set" data-title=""></a>
				<div class="hover-fx"><div class="expand-cta">EXPAND</div></div>
